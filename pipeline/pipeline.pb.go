...
type PipeOptions struct {
	...
	//   (when true).
	GenPubsubTopic string `protobuf:"bytes,1,opt,name=gen_pubsub_topic,json=genPubsubTopic,proto3" json:"gen_pubsub_topic,omitempty"`
}
...
func (x *PipeOptions) GetGenPubsubTopic() string {
	if x != nil {
...
var file_pipeline_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x67, 0x65, 0x6e, 0x50, 0x75, 0x62, 0x73, 0x75,
